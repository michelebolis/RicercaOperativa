...
var massimo; # Massima distanza tra tutte le coppie
# VINCOLI
...
subject to vincoloMassimo{p in Ponti, c in Coppie} : massimo >= distanze[c, p] * y[c, p]; 
# FUNZIONE OBIETTIVO
# minimizzare la distanza massima tra tutte le coppie
minimize distanzaMassima : massimo;
#############
data;
param nPonti := 4; 
